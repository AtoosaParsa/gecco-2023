...
class switch():
    ...
    def evaluate2(stiffness, ind1, ind2, ind3):       
        ...
        nandness2 = abs(round(gain00, 2)) * abs(round(gain01, 2)) * abs(round(gain10, 2)) / abs(round(gain11, 2))

        worst = max(abs(1-round(gain00, 2)), abs(1-round(gain01, 2)), abs(1-round(gain10, 2)), abs(0-round(gain11, 2)))

        return [nandness1, nandness2, worst, gain00, gain01, gain10, gain11]

    def showPacking(stiffness, ind1, ind2, alphas, label):
        #k1 = 1.
        #k2 = 10.
        ...
        # show packing
        ConfigPlot_DiffStiffness4(N, x0, y0, D, [Lx,Ly], stiffness, 0, '/Users/atoosa/Desktop/results/packing.pdf', ind_in1, ind_in2, ind_s, ind_out, alphas, label)
