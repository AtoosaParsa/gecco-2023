...
def ConfigPlot_DiffStiffness4(N, x, y, D, L, stiffness, mark_print, hn, in1, in2, so, out, alphas, label):
    ...
    for i in range(N):
        ...
        for k in range(-1, 2):
            for l in range(-1, 2):                        
                ...
                e.set_linewidth(0.5)
                if i==in1:
                    plt.scatter(x_now, y_now, marker='^', s=900, color=(0, 1, 0, 1))
                elif i==in2:
                    plt.scatter(x_now, y_now, marker='s', s=900, color=(0, 0, 1, 1))
                elif i==out:
                    plt.scatter(x_now, y_now, marker='*', s=900, color=(1, 0, 0, 1))
                elif i==so:
                    plt.scatter(x_now, y_now, marker='o', s=900, color=(1, 0, 1, 1))
    ...
    #plt.clim(0, 1)
    #cbar=plt.colorbar()
    #cbar.set_label(label, fontsize=42)
