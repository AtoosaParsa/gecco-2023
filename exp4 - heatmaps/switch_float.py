...
from ConfigPlot import ConfigPlot_DiffStiffness5, ConfigPlot_DiffStiffness4
import random
...
class switch():
    def evaluate(stiffness, ind1, ind2):       
        ...
        nandness1 = (abs(1-round(gain00, 2)) + abs(1-round(gain01, 2)) + abs(1-round(gain10, 2)) + abs(0-round(gain11, 2)))/4

        worst1 = max(abs(1-round(gain00, 2)), abs(1-round(gain01, 2)), abs(1-round(gain10, 2)), abs(0-round(gain11, 2)))
        ...
        nandness2 = (abs(1-round(gain00, 2)) + abs(1-round(gain01, 2)) + abs(1-round(gain10, 2)) + abs(0-round(gain11, 2)))/4

        worst2 = max(abs(1-round(gain00, 2)), abs(1-round(gain01, 2)), abs(1-round(gain10, 2)), abs(0-round(gain11, 2)))

        return [-1 * worst1, -1 * worst2, nandness1, nandness2]

    def evaluate2(stiffness, ind1, ind2, ind3):       
        #%% Initial Configuration
        #k1 = 1.
        #k2 = 10.
        ...
        ind_in1 = ind1 #int((n_col+1)/2) - 1 + n_col * 2
        ind_in2 = ind2 #ind_in1 + 2
        ind_out = ind3 #int(N-int((n_col+1)/2))
        ind_s = int((n_col+1)/2)
        #ind_fix = int((n_row+1)/2)*n_col-int((n_col+1)/2)
        ...
        gain11_1 = out1/((src+inp1+inp2))

        nandness1_1 = (abs(1-round(gain00_1, 2)) + abs(1-round(gain01_1, 2)) + abs(1-round(gain10_1, 2)) + abs(0-round(gain11_1, 2)))/4
        nandness2_1 = abs(round(gain00_1, 2)) * abs(round(gain01_1, 2)) * abs(round(gain10_1, 2)) / abs(round(gain11_1, 2))

        worst_1 = max(abs(1-round(gain00_1, 2)), abs(1-round(gain01_1, 2)), abs(1-round(gain10_1, 2)), abs(0-round(gain11_1, 2)))
        ...
        gain11_2 = out1/((src+inp1+inp2))

        nandness1_2 = (abs(1-round(gain00_2, 2)) + abs(1-round(gain01_2, 2)) + abs(1-round(gain10_2, 2)) + abs(0-round(gain11_2, 2)))/4
        nandness2_2 = abs(round(gain00_2, 2)) * abs(round(gain01_2, 2)) * abs(round(gain10_2, 2)) / abs(round(gain11_2, 2))

        worst_2 = max(abs(1-round(gain00_2, 2)), abs(1-round(gain01_2, 2)), abs(1-round(gain10_2, 2)), abs(0-round(gain11_2, 2)))

        return [nandness1_1, nandness2_1, worst_1, gain00_1, gain01_1, gain10_1, gain11_1, nandness1_2, nandness2_2, worst_2, gain00_2, gain01_2, gain10_2, gain11_2]

    def showPacking(stiffness, ind1, ind2, alphas, betas, label):
        #k1 = 1.
        #k2 = 10.
        ...
        # show packing
        ConfigPlot_DiffStiffness4(N, x0, y0, D, [Lx,Ly], stiffness, 0, '/Users/atoosa/Desktop/results/packing.pdf', ind_in1, ind_in2, ind_s, ind_out, alphas, betas, label)


    def showPacking2(stiffness, ind1, ind2, source, out):
        #k1 = 1.
        #k2 = 10.
        ...
        ind_in1 = ind1 #int((n_col+1)/2) - 1 + n_col * 2
        ind_in2 = ind2 #ind_in1 + 2
        ind_out = out #int(N-int((n_col+1)/2))
        ind_s = int((n_col+1)/2)
        #ind_fix = int((n_row+1)/2)*n_col-int((n_col+1)/2)

        # show packing
        ConfigPlot_DiffStiffness5(N, x0, y0, D, [Lx,Ly], stiffness, 0, '/Users/atoosa/Desktop/results/packing.pdf', ind_in1, ind_in2, ind_s, ind_out)
    ...
    def plotInOut2(stiffness, ind1, ind2, ind3):
