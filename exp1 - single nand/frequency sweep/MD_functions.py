...
Variable stiffness particles by Dong Wang
...
def MD_VibrSP_ConstV_Yfixed_DiffK(stiffness, B, Nt, N, x_ini, y_ini, D0, m0, L, Freq_Vibr, Amp_Vibr, ind_s, Amp_Vibr1, ind_in1, Amp_Vibr2, ind_in2, ind_out):
