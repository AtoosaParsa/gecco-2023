...
def ConfigPlot_DiffStiffness4(N, x, y, D, L, stiffness, mark_print, hn, in1, in2, so, out):
    ...
    plt.legend(loc='upper center', handles=[red_star, green_triangle, blue_square, black_circle], bbox_to_anchor=(0.5, -0.10), ncol=4, fontsize=28)
    plt.set_cmap("Greys")
    plt.clim(k_min, k_max)
    cbar=plt.colorbar()
    cbar.set_label("Stiffness", fontsize=42)
    cbar.ax.tick_params(labelsize=42, width=2, length=7)
